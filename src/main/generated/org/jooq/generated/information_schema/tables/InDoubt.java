...
public class InDoubt extends TableImpl<InDoubtRecord> {
    ...
    private static final long serialVersionUID = 1348813306;
    /**
     * The column <code>INFORMATION_SCHEMA.IN_DOUBT.TRANSACTION</code>.
     */
    public final TableField<InDoubtRecord, String> TRANSACTION = createField(DSL.name("TRANSACTION"), org.jooq.impl.SQLDataType.VARCHAR(2147483647),
        this, "");
    /**
