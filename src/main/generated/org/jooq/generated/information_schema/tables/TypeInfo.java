...
public class TypeInfo extends TableImpl<TypeInfoRecord> {
    ...
    private static final long serialVersionUID = -300739379;
    /**
     * The column <code>INFORMATION_SCHEMA.TYPE_INFO.TYPE_NAME</code>.
     */
    public final TableField<TypeInfoRecord, String> TYPE_NAME = createField(DSL.name("TYPE_NAME"), org.jooq.impl.SQLDataType.VARCHAR(2147483647),
        this, "");
    /**
