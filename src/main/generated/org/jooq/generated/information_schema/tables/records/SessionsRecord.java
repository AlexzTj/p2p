...
public class SessionsRecord extends TableRecordImpl<SessionsRecord> implements
    Record8<Integer, String, OffsetDateTime, String, OffsetDateTime, Boolean, String, Integer> {

    private static final long serialVersionUID = 1980460617;
     ...
     */
    public SessionsRecord(Integer id, String userName, OffsetDateTime sessionStart, String statement, OffsetDateTime statementStart,
        Boolean containsUncommitted, String state, Integer blockerId) {
        super(Sessions.SESSIONS);
    ...
    @Override
    public SessionsRecord values(Integer value1, String value2, OffsetDateTime value3, String value4, OffsetDateTime value5, Boolean value6,
        String value7, Integer value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
