...
public class QueryStatisticsRecord extends TableRecordImpl<QueryStatisticsRecord> implements
    Record12<String, Integer, Double, Double, Double, Double, Double, Integer, Integer, Long, Double, Double> {

    private static final long serialVersionUID = -1438380420;
     ...
     */
    public QueryStatisticsRecord(String sqlStatement, Integer executionCount, Double minExecutionTime, Double maxExecutionTime,
        Double cumulativeExecutionTime, Double averageExecutionTime, Double stdDevExecutionTime, Integer minRowCount, Integer maxRowCount,
        Long cumulativeRowCount, Double averageRowCount, Double stdDevRowCount) {
        super(QueryStatistics.QUERY_STATISTICS);
    ...
    @Override
    public QueryStatisticsRecord values(String value1, Integer value2, Double value3, Double value4, Double value5, Double value6, Double value7,
        Integer value8, Integer value9, Long value10, Double value11, Double value12) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
